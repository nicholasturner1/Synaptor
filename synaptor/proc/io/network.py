...
def read_network_from_proc(proc_dir_path):
    ...
    model_fname = os.path.join(proc_dir_path, fn.network_dirname, fn.network_fname)
    chkpt_fname = os.path.join(proc_dir_path, fn.network_dirname, fn.network_chkpt)
...
def write_network_to_proc(net_fname, chkpt_fname, proc_dir_path):
    ...
    dest_net_fname   = os.path.join(proc_dir_path, fn.network_dirname, fn.network_fname)
    dest_chkpt_fname = os.path.join(proc_dir_path, fn.network_dirname, fn.network_chkpt)
